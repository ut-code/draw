...
export const tutorialSteps = [
  ...
  },
  {
    ...
    content: (
      <>
        <Text my={2}>
          ペンと繰り返し文を組み合わせると以下のように正多角形を描くことができます。まずペンの座標を設定して、ペンの角度が360度になるまで、「30度回転して50だけ進む」という動作を繰り返します。ペンは30度ずつ回転するので、ペンの角度が360度になったということは外角の和が360度になったということで、ペンが初期位置に戻ったということになります。
        </Text>
        <Text my={2}>実際に実行して確かめてみましょう。</Text>
